...
from vision.ssd.proposed_ssd import create_proposed_ssd, create_proposed_ssd_predictor
...
if net_type == 'vgg16-ssd':
    ...
    predictor = create_proposed_ssd_predictor(net, candidate_size=200)
else:
    predictor = create_vgg_ssd_predictor(net, candidate_size=200)
...
for i in range(boxes.size(0)):
    ...
    print(box)
    print(int(box[0]))
    cv2.rectangle(orig_image, (int(box[0]), int(box[1])), (int(box[2]), int(box[3])), color=[255, 255, 0], thickness=4)
    print(int(box[0]))
